...
void setClock(void *pvParameters)
{
    ...
    ESP_LOGI(pcTaskGetTaskName(0), "timeinfo.tm_sec=%d",timeinfo.tm_sec);
    ESP_LOGI(pcTaskGetTaskName(0), "timeinfo.tm_min=%d",timeinfo.tm_min);
    ESP_LOGI(pcTaskGetTaskName(0), "timeinfo.tm_hour=%d",timeinfo.tm_hour);
    ESP_LOGI(pcTaskGetTaskName(0), "timeinfo.tm_wday=%d",timeinfo.tm_wday);
    ESP_LOGI(pcTaskGetTaskName(0), "timeinfo.tm_mday=%d",timeinfo.tm_mday);
    ESP_LOGI(pcTaskGetTaskName(0), "timeinfo.tm_mon=%d",timeinfo.tm_mon);
    ESP_LOGI(pcTaskGetTaskName(0), "timeinfo.tm_year=%d",timeinfo.tm_year);
